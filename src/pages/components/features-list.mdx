...
<PropsTable data={[
  { name: 'items', type: 'string[]', required: true, description: 'Array of feature descriptions rendered as list items.' },
  { name: 'caption', type: 'string | null', default: 'null', description: 'Optional heading rendered above the list.' },
]} />
...
| Class | Purpose |
| --- | --- |
| `features-list-caption` | Heading style above the list |
| `features-list-ul` | The `<ul>` container styling |
| `features-list-item` | Individual `<li>` row styling |