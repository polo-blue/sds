...
<PropsTable data={[
  { name: 'prcode', type: 'PrCodeObject', required: true, description: 'PR code object — see shape below.' },
...
<PropsTable data={[
  { name: 'prcodes', type: 'PrCodeObject[]', required: true, default: '[]', description: 'Array of PR code objects.' },
  { name: 'isPdp', type: 'boolean', default: 'false', description: 'Product detail page styling.' },
]} />
