...
<div class="component-preview">
  ...
  <Drawer id="right-drawer" label="Side panel">
...
<style>
  #right-drawer .sds-drawer-panel {
    left: auto;
    right: 0;
    transform: translateX(100%);
  }

  #right-drawer.open .sds-drawer-panel {
...
Slide from the right edge by overriding positioning:
...
#my-drawer.open .sds-drawer-panel {
  transform: translateX(0);
}
```

Or use this HTML pattern directly if not using the Astro component.
