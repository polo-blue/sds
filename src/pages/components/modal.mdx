...
<Modal id="dialog1" open="Open modal" title="Modal Title">
  ...
  html={`<button onclick="document.getElementById('dialog1').showModal()">Open modal</button>
...
<ComponentPreview client:visible
  astro={`<Modal id="dialog2" open="Delete Item" title="Confirm Delete" showActions cancelText="Cancel" confirmText="Delete">
...
<ComponentPreview client:visible
  astro={`<Modal id="dialog4" open="Wide Modal" title="Large Content" maxWidth="900px">
...
<ComponentPreview client:visible
  astro={`<Modal id="dialog5" open="Open modal" title="Custom Close" showXButton={false}>
...
<PropsTable data={[
  { name: 'id', type: 'string', required: true, description: 'Unique identifier for the modal' },
  { name: 'open', type: 'string', default: "'Open modal'", description: 'Text for the trigger button' },
  { name: 'title', type: 'string', default: 'undefined', description: 'Modal title (shown in header)' },
  { name: 'maxWidth', type: 'string', default: "'600px'", description: 'Maximum width of the modal' },
  { name: 'showXButton', type: 'boolean', default: 'true', description: 'Show X close button in top-right' },
  { name: 'showTrigger', type: 'boolean', default: 'true', description: 'Show the trigger button' },
  { name: 'showActions', type: 'boolean', default: 'false', description: 'Show action buttons footer' },
  ...
  { name: 'confirmPrimary', type: 'boolean', default: 'true', description: 'Make confirm button primary style' },
]} />
