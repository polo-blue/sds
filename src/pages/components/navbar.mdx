...
<ComponentPreview client:visible
  ...
  <div slot="actions" class="flex items-center gap-2">
    ...
    <a href="#" class="px-5 py-2 rounded-full text-sm font-textbold text-white bg-gradient-to-r from-blue-medium to-blue-dark hover:opacity-90 transition-opacity">
      Contact
    </a>
  </div>
</Navbar>
