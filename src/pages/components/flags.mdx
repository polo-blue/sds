...
For other flags, use the `circle-flags` icon collection via [`astro-icon`](https://github.com/natemoo-re/astro-icon) — `<Icon name="circle-flags:xx" />` where `xx` is the country code.