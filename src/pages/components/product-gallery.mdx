...
<PropsTable data={[
  { name: 'images', type: 'GalleryImage[]', required: false, default: '[]', description: 'Array of image objects.' },
  { name: 'aspectRatio', type: 'string', default: "'4/3'", description: 'CSS `aspect-ratio` for the slider.' },
  { name: 'class', type: 'string', required: false, description: 'Additional CSS class on root element.' },
  { name: 'ariaLabel', type: 'string', default: "'Product image gallery'", description: 'Accessible label for the carousel region.' },
]} />
...
interface GalleryImage {
  src: string;    // Main image URL (used in slider) — required
...
<script>
  import '../../scripts/product-gallery-docs-init';
</script>
